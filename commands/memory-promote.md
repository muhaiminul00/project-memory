...
This is the "Ingest" workflow: take a durable fact or decision - ARGUMENTS if given, otherwise ask what's being promoted rather than inventing one - and give it a permanent home in this project's Wiki (default `.project-memory/Wiki/`, or wherever this project's `.claude/CLAUDE.md` or root CLAUDE.md names it instead).
